...
<head>
	<title>Besopke CMS Manager Login</title>
...
{$_lang.login_copyright}<br />
Bespoke CMS is a distribution of MODX provided by <a href="http://bonifier.com.hk" target="_blank">Bespoke de Bonifier, Bonifier Co.</a>
</p>
</div>
